...
INSERT INTO `applications` VALUES (1,1,1,'2024-01-10','Accepted'),(2,2,2,'2024-01-12','Accepted'),(3,3,3,'2024-01-15','Rejected'),(4,4,4,'2024-01-18','Pending'),(5,5,5,'2024-01-20','Accepted'),(6,6,6,'2024-01-22','Accepted'),(7,7,7,'2024-01-25','Accepted'),(8,8,1,'2024-01-28','Pending'),(9,1,3,'2024-02-01','Accepted'),(10,2,5,'2024-02-05','Rejected');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `GetPassRate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GetPassRate`(p_PositionID INT) RETURNS decimal(5,2)
    DETERMINISTIC
BEGIN
    DECLARE total INT;
    DECLARE passed INT;
    ...
    SELECT COUNT(*) INTO total 
    FROM Applications WHERE PositionID = p_PositionID;
    
    SELECT COUNT(*) INTO passed 
    FROM Applications a JOIN Interviews i 
    ON a.ApplicationID = i.ApplicationID
    WHERE a.PositionID = p_PositionID AND i.Result = 'Pass';
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ConfirmApplication` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ConfirmApplication`(
...
BEGIN
    ...
    SELECT a.ApplicationID, c.CandidateName, p.PositionName, a.Status
    FROM Applications a
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jobapplicationsummaries` AS select `p`.`PositionName` AS `PositionName`,count(`a`.`ApplicationID`) AS `TotalApplications` from (`jobpositions` `p` left join `applications` `a` on((`p`.`PositionID` = `a`.`PositionID`))) group by `p`.`PositionName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-04-08 16:26:50
